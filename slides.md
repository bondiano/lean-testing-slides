...
```javascript{1-7|8-22|9-14|15-18|19-21}
...
* Моками бэка можно пользоваться в мануальном режиме
* Любое не реальное окружение достаточно не надежно
* Тестирование обнаруживает присутствие, а не отсутствие багов. *Дейкстра*
...
<div class="flex justify-center">
  <img src="/just_do_it.jpeg" style="height: 200px">
</div>
